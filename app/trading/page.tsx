...
export default function TradingPage() {
  ...
  const closeText = closeSide === "sell" ? "Sell to Close" : "Buy to Close";
    ...
    >
      <div className="space-y-6">
        <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-5">
          ...
          <div className="mt-4 grid gap-3 xl:grid-cols-[1.4fr_1fr_1fr_auto_auto]">
            <select
              value={selectedAlgo}
          ...
          <div className="space-y-6">
            <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-5">
              ...
              <div className="rounded-3xl border border-white/10 bg-black/30 p-6">
                ...
                <div className="mt-4 flex h-[520px] flex-col justify-between rounded-2xl border border-dashed border-white/10 bg-gradient-to-b from-white/[0.03] to-transparent p-6">
                  <div>
